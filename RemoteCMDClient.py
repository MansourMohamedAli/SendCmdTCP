...
def open_connection_thread(server_host_ip, server_host_port, command, max_attempts, iplocal, timer):
...
def main(args=None):
    ...
    parser.add_argument('--timer', type=str.lower, help=f'Timer for server response.', default="false", choices=["true", "false"])
